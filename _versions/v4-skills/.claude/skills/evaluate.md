---
description: Evaluate implementation quality with scoring rubric
tags: [review, evaluation, quality]
---

# Code Evaluation

Evaluate recent changes against project standards with detailed scoring.
...
- Reuse of existing components, patterns, utilities
...
For each: explain what's done well, issues, differences from best practices.

Finally: overall assessment with **score /100** and what senior/production solution would improve.
...
After implementing, run `/evaluate` for comprehensive quality assessment.
